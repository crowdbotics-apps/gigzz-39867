"""
Django settings for gigzz_39867 project.
...
WSGI_APPLICATION = 'gigzz_39867.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gigzz_39867 API",
    "DESCRIPTION": "API documentation for gigzz_39867 App",
    "VERSION": "v1",
}
